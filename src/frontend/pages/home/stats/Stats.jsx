...
const Stats = () => {
  return (
    <div className="w-full select-none">
        <div className='max-w-2xl 2xl:max-w-5xl xl:max-w-4xl lg:max-w-3xl lg:px-0 px-8 max-lg:gap-y-8 *:relative *:z-10 mx-auto flex flex-wrap items-center w-full overflow-hidden rounded-md py-8 relative bg-zinc-300'>
